<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminCityPlaces.aspx.cs" Inherits="RLL.AdminCityPlaces" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="w-100">
        ...
        <tr>
            <td style="height: 53px"><strong>City</strong></td>
